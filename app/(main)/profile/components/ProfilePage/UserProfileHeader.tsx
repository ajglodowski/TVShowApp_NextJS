...
export async function LoadingUserProfileHeader() {
    return (
        ...
        <div className="space-y-1 flex-1">
            <div className="flex items-center gap-4">
                <span className="text-2xl font-bold"><Skeleton className="h-8 w-full" /></span>
            </div>
            <span className="text-muted-foreground font-bold"><Skeleton className="h-4 w-full" /></span>
            <div className="flex space-x-1  text-muted-foreground items-center">
                <Tv className="h-4 w-4" />
                <span className="flex items-center gap-1"><Skeleton className="h-4 w-8" /> Shows Logged</span>
            </div>
            <span className="text-sm mt-2 max-w-md pb-2">
        ...
        <div className="flex flex-col gap-2 text-sm md:text-right">
            <div className="flex items-center gap-2 hover:underline cursor-pointer">
                <Users className="h-4 w-4" />
                <span className="flex items-center gap-1 font-medium"><Skeleton className="h-4 w-8" /> Followers</span>
            </div>
            <div className="flex items-center gap-2 hover:underline cursor-pointer">
                <Users className="h-4 w-4" />
                <span className="flex items-center gap-1 font-medium"><Skeleton className="h-4 w-8" /> Following</span>
            </div>
        </div>
        <div className="flex flex-col gap-2 my-2 hover:underline cursor-pointer">
            <span className="text-muted-foreground flex items-center gap-2 text-sm">
                Visit <Skeleton className="h-4 w-24" />'s Watchlist
                <ChevronRight className="h-4 w-4" />
            </span>
        </div>
    </div>
